...
let boardInfo3 = BoardInfo(address: "부산시 해운대구", boardType: BoardTypes.basic, boardID: 1002, registerTime: "2023-09-05 10:45:00", lat: 37.481778845776, lng : 126.79888278525)

let boardInfo4 = BoardInfo(address: "부산시 해운대구", boardType: BoardTypes.basic, boardID: 1002, registerTime: "2023-09-05 10:45:00", lat: 37.481774875776, lng : 126.79543178525)

var profile = UserInfo( nickname: "노스크럼", userId: "importantMorning", userPw: "Shtmzmfja7&", email: "example@email.com", isUsing: false, isLogin: false, profileImageUrl: nil, usageHistory: [history1,history2], bilBoardInfos: [boardInfo1,boardInfo2,boardInfo3,boardInfo4], currentLat: 37.481776875776, currentLng: 126.79742178525 )
